...
(function(){
  ...
  openArticleVisual=function(id){artOpen=true;thresholdDirty=true;_origOpen(id)};
  ...
  openArticleVisualImmediate=function(id){artOpen=true;thresholdDirty=true;_origImm(id)};
