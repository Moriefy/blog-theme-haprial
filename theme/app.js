...
function openArticleVisual(id){scrollPos=window.scrollY;loadArticle(id);lockBody();articleView.classList.add('open');avBar.classList.remove('scrolled');fabComment.classList.add('visible');fabComment.classList.remove('shifted')}
...
window.addEventListener('scroll',function(){if(_mainScrollPending)return;_mainScrollPending=true;requestAnimationFrame(function(){_mainScrollPending=false;handleMainScroll()})},{passive:true});
