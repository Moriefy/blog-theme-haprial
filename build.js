...
<footer class="site-footer">
  ...
  <p class="footer-powered">Powered by <a href="https://github.com/Moriefy/blog-theme-haprial" target="_blank" rel="noopener">Haprial</a></p>
</footer>
...
function seoPageFoot() {
  return `</main>
<footer class="site-footer"><p class="footer-copy">© ${new Date().getFullYear()} ${escHtml(SITE_CONFIG.title)}</p><p class="footer-powered">Powered by <a href="https://github.com/Moriefy/blog-theme-haprial" target="_blank" rel="noopener">Haprial</a></p></footer>
</body></html>`;
}
