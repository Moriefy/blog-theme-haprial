...
<header class="top-app-bar" id="topAppBar">
  <span class="logo" id="logoBtn">${escHtml(config.author)}</span>
...
<section class="page active" id="pageArticles" itemscope itemtype="https://schema.org/Blog"><div class="container">
  <section class="hero"><h1>${escHtml(config.title)}</h1><p>${escHtml(config.tagline)}</p></section>
...
<header class="top-app-bar" id="topAppBar">
  <span class="logo" onclick="location.href='/'" style="cursor:pointer">${escHtml(config.author)}</span>
  <div class="spacer"></div>
