(function(){
'use strict';
var API='https://your-comments-worker.your-subdomain.workers.dev';
...
function renderSettings(){
  ...
  c.innerHTML='<div class="settings-section"><h3>修改密码</h3>'
    ...
    +'<div style="max-width:400px">'
    +'<div style="margin-bottom:12px"><label style="display:block;font-size:12px;font-weight:600;color:var(--on-surface-variant);margin-bottom:4px">网站地址</label><input class="md3-input" id="setWebsite" value="'+esc(adminWebsite)+'" placeholder="https://your-domain.com"></div>'
